...
class DatasetManagementMessage(AbstractInitRequest):
    ...
    blk_start: Optional[int] = Field(description="Optional starting point for when acting upon a block/chunk of data.")
    blk_size: Optional[int] = Field(description='Optional block size for when acting upon a block/chunk of data.')
    ...
    class Config:
        fields = {
            ...
            "blk_start": {"alias": "data_blk_start"},
            "blk_size": {"alias": "data_blk_size"},
        }
    ...
    def __init__(
        ...
        **data
        ...
        super().__init__(
            ...
            blk_start=blk_start or data.pop("data_blk_start", None),
            blk_size=blk_size or data.pop("data_blk_size", None),
